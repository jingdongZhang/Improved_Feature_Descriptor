...
%   USA
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function calibrationZJD(calib_data)

format long;


if isempty(calib_data.ima_proc)
    fprintf(1,'\nNo feature data available. Extract features before calibrating.\n\n');
    return;
end
...
%[calib_data.RRfin,calib_data.ocam_model.ss]=calibrateZJD_test(calib_data);
[calib_data.RRfin,calib_data.ocam_model.ss]=calibrateZJD(calib_data);
